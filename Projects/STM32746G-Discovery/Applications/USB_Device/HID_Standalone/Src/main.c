// main.c - usb hid
char* kVersion = "USB HID keyboard 20/2/18";
//{{{  includes
#include "../../../utils.h"
#include "../../../usbd.h"
//}}}
...
__ALIGN_BEGIN static uint8_t kHidKeyboardReportDescriptor[78] __ALIGN_END = {
...
//}}}
//{{{
static uint8_t hidSendKeyboardReport (USBD_HandleTypeDef* device) {
